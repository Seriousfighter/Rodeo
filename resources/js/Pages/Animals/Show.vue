                ...
                <div class="flex justify-between items-center py-6">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            Información completa del animal registrado
                        </p>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            <Link 
                                :href="route('rodeos.show', animal.rodeo.id)"
                            ...
                            <Link 
                                :href="route('clients.show', animal.rodeo.client.id)"
                                ...
                                <div class="bg-blue-50 rounded-lg p-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-lg font-bold text-blue-600">{{ getDaysRegistered() }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                ...
                <p class="text-gray-600 mb-6">
                    ¿Estás seguro de que deseas eliminar el animal con caravana <strong>{{ animal.caravana }}</strong>? 
...
const deleteAnimal = () => {
    router.delete(route('animals.destroy', props.animal.id), {
        onSuccess: () => {
